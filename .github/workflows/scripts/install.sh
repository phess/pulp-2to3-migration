...
if [ -e $REPO_ROOT/../pulp_container ]; then
  ...
  PULP_CONTAINER=git+https://github.com/pulp/pulp_container.git@2.9
fi

if [ -e $REPO_ROOT/../pulp_rpm ]; then
  PULP_RPM=./pulp_rpm
else
  PULP_RPM=git+https://github.com/pulp/pulp_rpm.git@3.16
fi

if [ -e $REPO_ROOT/../pulp_deb ]; then
  PULP_DEB=./pulp_deb
else
  PULP_DEB=git+https://github.com/pulp/pulp_deb.git@2.16
fi
